...
class LVISDataset(CustomDataset):
    ...
    CLASSES = (
        'background','aerosol_can', 'air_conditioner', 'airplane', 'alarm_clock', 'alcohol',
    ...
    pallte = sns.color_palette(n_colors=len(CLASSES)-1)
    pallte = [list(map(lambda x:int(x*255),p)) for p in pallte]
    PALETTE = [[0,0,0]] + pallte

    def __init__(self, **kwargs):
        super(LVISDataset, self).__init__(img_suffix='.jpg', seg_map_suffix='.png', **kwargs)
